											...
											<form method="post" action="">
												<fieldset>
													...
													<div class="clearfix">
														...
														<button type="submit" name="btn_submit" class="width-35 pull-right btn btn-sm btn-primary">
											...
											<form action="" method= "POST">
												<fieldset>
													...
													<div class="clearfix">
														...
														<button type="submit" class="width-65 pull-right btn btn-sm btn-success" name="btn_submit" >
