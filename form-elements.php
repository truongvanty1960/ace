                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" method="post" action="">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Edit
                                    Username </label>

                                <div class="col-sm-9">
                                    <input type="text" placeholder="Username" value="<?php echo $query2['username']; ?>"
                                           name="username" class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Edit
                                    Email </label>

                                <div class="col-sm-9">
                                    <input type="text" placeholder="Text Field" value="<?php echo $query2['email']; ?>"
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Edit
                                    Password </label>

                                <div class="col-sm-9">
                                    <input type="text" placeholder="Password" value="<?php echo $query2['password']; ?>"
