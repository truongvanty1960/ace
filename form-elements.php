...
if (isset($_GET['id'])) {
    ...
    if (isset($_POST['btn_submit'])) {
        ...
        $email = $_POST['email'];
        $query3 = mysqli_query($conn, "update user set username='$username', password='$password', email = '$email' where id='$id'");
        if ($query3) {
                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" method="post" action="">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Edit Username </label>

                                <div class="col-sm-9">
                                    <input type="text" placeholder="Username" value="<?php echo $query2['username']; ?>" name="username" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Edit Email </label>

                                <div class="col-sm-9">
                                    <input type="text"  placeholder="Text Field" value="<?php echo $query2['email']; ?>" name="email" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-2">  Edit Password </label>

                                <div class="col-sm-9">
                                    <input type="text"  placeholder="Password" value="<?php echo $query2['password']; ?>" name="password" class="col-xs-10 col-sm-5" />
