...
while ($row = mysqli_fetch_array($result)) {
    ...
    $asd["id"] = $row["idpost"];
    $asd["title"] = $row["title"];
    $asd["description"] = $row["description"];
    array_push($json, $asd);
}
?>
<!DOCTYPE html>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div>
                            ...
                            <select id="category" name="category">
                                ...
                                $category = mysqli_query($conn, "SELECT category_name FROM category WHERE 1");
...
<script type="text/javascript">
    var grid_data = <?php echo json_encode($json);?>
//        [
...
//            },
            ...
            colModel: [
                ...
                {name: 'title', index: 'title', width: 150, editable: true, edittype:'text'},
